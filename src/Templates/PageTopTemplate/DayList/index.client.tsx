  ...
  return (
    <div className="flex w-full">
      <div className="relative flex items-center justify-center w-16 h-16 mt-3 ml-2 group">
        <button
          className="flex items-center justify-center w-full h-full rounded-full border bg-opacity-50 bg-white"
          style={{
            boxShadow:
        ...
        <span className="absolute top-full mt-2 p-1 hidden text-center text-sm text-white bg-black group-hover:flex text-white bg-gray-600">
          作成
        </span>
      </div>
